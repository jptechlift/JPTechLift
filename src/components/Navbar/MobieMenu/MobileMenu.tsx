    ...
    <>
      ...
      <div className={`${styles.menuPanel} ${isOpen ? styles.menuPanel__open : ""}`}>
        <div className={styles.menuInner}>
          ...
          {menuLevel === "product" && (
            <ul className={styles.menuList}>
              <li onClick={() => navigate("/product/home-lift")}>
                <a><span>THANG MÁY GIA ĐÌNH</span> <span>→</span></a>{" "}
              </li>
              <li onClick={() => navigate("/product/passenger-elevator")}>
                <a><span>THANG MÁY DÂN DỤNG</span> <span>→</span></a>{" "}
              </li>
              <li onClick={() => navigate("/product/freight-lift")}>
                <a> <span>THANG MÁY CHỞ HÀNG</span> <span>→</span></a>
              </li>
              <li onClick={() => navigate("/product/panorama-lift")}>
                <a><span>THANG MÁY QUAN SÁT</span> <span>→</span></a>{" "}
              </li>
              <li onClick={() => navigate("/product/hospital-lift")}>
                <a><span>THANG MÁY BỆNH VIỆN</span> <span>→</span></a>{" "}
              </li>
              <li onClick={() => navigate("/product/food-lift")}>
