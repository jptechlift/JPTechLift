...
export default function RealGallerySection({ images }: Props) {
  ...
  return (
    <section id="real-gallery" className={styles.realGallerySection}>
      <h2 className={styles.heading} data-aos="fade-up">Hình ảnh thực tế</h2>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.textBox} data-aos="fade-left">
          ...
          <p>
            Mỗi công trình là một hành trình riêng: từ khảo sát thực tế, lên phương án thi công,
            cho đến khi vận hành trơn tru và bàn giao cho khách hàng.
          </p>
          <p>
          ...
          <p>
            Muốn hiểu rõ hơn về cách chọn thang máy đúng nhu cầu? Đừng bỏ qua những bài viết chuyên sâu
            và kinh nghiệm thực tế từ đội ngũ của chúng tôi.
          </p>

          <div className={styles.buttons} data-aos="zoom-in-up">
