...
export default function AboutUsIntro() {
  ...
  return (
    <section className={styles.introSection}>
      <h1 className={styles.heading} data-aos="fade-up">GIỚI THIỆU CHUNG</h1>
      ...
      <div className={styles.content} data-aos="fade-up" data-aos-delay="200">
        ...
        <p className={styles.slogan} data-aos="fade-up" data-aos-delay="600">
          JP TechLift – An toàn là tối thượng, Chất lượng là danh dự.
        </p>

        <div className={styles.signature} data-aos="fade-up" data-aos-delay="700">
