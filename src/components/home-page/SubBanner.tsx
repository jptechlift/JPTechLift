...
/**
 * Marketing banner with background image and a call-to-action link.
 */
    ...
    <div className="relative w-full h-[500px] overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-[1200px]">
        <img
         ...
         className="mx-auto w-20 md:w-26 lg:w-32 transition-all duration-700 drop-shadow-[0_4px_8px_rgba(0,0,0,0.4)] hover:scale-105"
