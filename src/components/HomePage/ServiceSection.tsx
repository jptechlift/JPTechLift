      ...
      >
        {services.map((service, idx) => (
          ...
          >
            ...
            <Link
              to={service.url}
              className="group mt-5 inline-flex items-center gap-2 border border-[#041E42] px-4 py-2 text-[#041E42] text-[14px] font-semibold hover:bg-[#041E42] hover:text-white transition-colors duration-300"
            >
              XEM THÊM
              <svg
      ...
      <div className="grid grid-cols-2 gap-4 md:hidden max-w-[480px] mx-auto" data-aos="fade-up" data-aos-delay="200">
        {MobileServices.map((service, idx) => (
          ...
          >
            ...
            <Link
              to={service.url}
              className="w-full border border-[#041E42] px-3 py-1.5 text-[12px] text-[#041E42] font-semibold hover:bg-[#041E42] hover:text-white transition-colors duration-300 text-center"
            >
              XEM THÊM
            </Link>
          </div>
