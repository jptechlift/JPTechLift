...
namespace backend.Migrations
{
    ...
    [Migration("20250910184650_IncreaseMetaDescriptionLength")]
    partial class IncreaseMetaDescriptionLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.User", b =>
                {
                    ...
                    b.HasIndex("AuthProvider", "ProviderSubject")
                        .IsUnique()
                        .HasDatabaseName("ix_users_auth_provider_provider_subject");
            ...
            modelBuilder.Entity("Backend.Models.ProductBlog", b =>
                {
                    b.HasOne("Backend.Models.Blog", "Blog")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_blogs_blogs_blog_id");
