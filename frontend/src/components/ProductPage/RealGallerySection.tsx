...
export default function RealGallerySection({ images }: Props) {
  ...
  return (
    <section id="real-gallery" className={styles["real-gallery"]}>
      ...
      <div className={styles["real-gallery__background"]}>
        <div className={styles["real-gallery__wrapper"]}>
          ...
          <div className={styles["real-gallery__text"]}>
            ...
            <div className={styles["real-gallery__content"]}>
              ...
              <p>
                <strong>Tiêu chuẩn 3A:</strong> An toàn - Tối ưu - Thẩm mỹ. Đây là kim chỉ nam trong từng bước triển
                khai dự án của chúng tôi.
              </p>
              ...
              <p className={styles["cta-text"]}>
                Bạn muốn tìm hiểu thêm về quy trình lắp đặt và các giải pháp thang máy? Khám phá thêm những chia sẻ
                chuyên sâu từ đội ngũ kỹ thuật của chúng tôi.
              </p>
            </div>
